...
def init_swanlab(config: _config.TrainConfig, *, resuming: bool, enabled: bool = True):
    ...
    if resuming:
        ...
        (ckpt_dir / "swanlab_id.txt").write_text(swanlab.run.id)
...
def train_loop(config: _config.TrainConfig):
    ...
    if is_main and config.swanlab_enabled and not resuming:
    ...
    while global_step < config.num_train_steps:
        ...
        for observation, actions in loader:
            ...
            if is_main and (global_step % config.log_interval == 0):
                ...
                if config.swanlab_enabled and len(infos) > 0:
                    log_payload = {
                        "loss": avg_loss,
    ...
    if is_main and config.swanlab_enabled:
        swanlab.finish()
