...
# LeRobot uses git-lfs; OpenCV needs the GL and GLib runtime libraries.
RUN apt-get update && apt-get install -y git git-lfs linux-headers-generic build-essential clang libgl1 libglib2.0-0
